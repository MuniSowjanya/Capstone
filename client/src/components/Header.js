                ...
                <div className="flex-container">
                    <div className="flexlogo">
                        ...
                        <div>
                            ...
                            <NavLink to={!currentUser ? '/user/login' : '/posting'}><button type="button" id="ad-btn" className="btn btn-outline-warning btn-lg resbtn3" >Post an Offer</button></NavLink>

                        </div>
                        <div>
                        <button type="button" id="ad-btn1" className="btn btn-outline-warning btn-lg resbtn3">
  <span className="glyphicon glyphicon-bell" aria-hidden="true"></span> Notification
</button>
                        </div>
                    </div>
